...
- After every subsection in §6 is checked and all acceptance criteria in §5 are met, the release is tagged and the next scope file (`TEMPLATE_V0_2_SCOPE.md`) is opened.

...
import app.modules.jobs.models  # pyright: ignore[reportUnusedImport]
import app.modules.maintenance.models  # pyright: ignore[reportUnusedImport]
import app.modules.notifications.models  # pyright: ignore[reportUnusedImport]
import app.modules.organisations.models  # pyright: ignore[reportUnusedImport]
import app.modules.outbox.models  # pyright: ignore[reportUnusedImport]
...
import app.modules.webhooks.models  # pyright: ignore[reportUnusedImport]

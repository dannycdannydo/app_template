...
1. Pick the next unchecked work unit in `TEMPLATE_V0_5_SCOPE.md` §6 (in sequence).
...
1. Start each work unit on its own branch: `git checkout -b feature/<unit>` (the unit name from `TEMPLATE_V0_5_SCOPE.md` §6).
